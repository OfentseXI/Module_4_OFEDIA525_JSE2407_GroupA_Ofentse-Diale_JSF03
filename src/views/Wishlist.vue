  ...
  <div class="container mx-auto p-6">
    <div class="mt-4 flex justify-between items-center flex-wrap mb-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 hover:scale-102">
        <div v-for="product in favoriteProducts" :key="product.id" class="card-container bg-white shadow-md rounded-lg overflow-hidden border p-4 cursor-pointer hover:border-black hover:-translate-y-1 hover:scale-102 duration-300 flex flex-col h-full">
